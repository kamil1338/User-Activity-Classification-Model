...
def execute():
    train_data = load_npy_file(npy_files_dir_path + 'train_y_data.npy')
    valid_data = load_npy_file(npy_files_dir_path + 'valid_y_data.npy')
    ...
    model.save(model_saving_dir_path + 'model_Y.h5')
